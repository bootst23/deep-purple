...
<template>
  ...
  <form class="w-full max-w-md" @submit.prevent="handleSubmit">
    <div class="flex gap-2">
      <Input type="text" placeholder="Ask me anything..." class="flex-grow" v-model="userInput" />
      <Button type="submit" variant="secondary" class="bg-purple-500 hover:bg-purple-600 text-white">
        Ask
      </Button>
    </div>
  </form>
